...
export function GoogleAuthButton({
          ...
          useEffect(() => {
                    ...
                    return () => {
                              // Cleanup is handled by the browser for script tags
                    };
          }, [onError]);
          ...
          const handleGoogleAuth = useCallback(() => {
                    if (!window.google?.accounts || !tokenClient) {
                    ...
                    try {
                              ...
                              setIsLoading(false);
                              logger.error('Failed to request Google access token:', error);
                              onError('Failed to start Google authentication');
                    }
          }, [tokenClient, disabled, isLoading, onError]);
          ...
          return (
                    <Button
                              ...
                              isLoading={isLoading}
                              className={`w-full border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-50 disabled:text-gray-400 ${className}`}
                    >
                              {!isLoading && (
